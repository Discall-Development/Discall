...
import _ws from './ws';
export default function client(_token: string, ws: ReturnType<typeof _ws>): (packet: HttpRequest) => Promise<any>;
export declare function create<T extends (...args: unknown[]) => unknown>(action: HttpRequestData, cache?: T, reason?: string): HttpRequest;
export declare function create(action: HttpRequestData, reason?: string): HttpRequest;
export declare function get<T extends (...args: unknown[]) => unknown>(action: HttpRequestData, cache?: T, reason?: string): HttpRequest;
export declare function get(action: HttpRequestData, reason?: string): HttpRequest;
export declare function edit<T extends (...args: unknown[]) => unknown>(action: HttpRequestData, cache?: T, reason?: string): HttpRequest;
export declare function edit(action: HttpRequestData, reason?: string): HttpRequest;
export declare function remove<T extends (...args: unknown[]) => unknown>(action: HttpRequestData, cache?: T, reason?: string): HttpRequest;
